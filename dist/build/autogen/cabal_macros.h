...
/* package hfind-0.1.0.0 */
#define VERSION_hfind "0.1.0.0"
#define MIN_VERSION_hfind(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hfind-0.1.0.0"

#define CURRENT_PACKAGE_KEY "hfind-0.1.0.0"
